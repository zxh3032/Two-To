...
type HealthResponse struct {
	...
	// status 表示服务整体健康状态，正常为 ok，降级为 degraded。
	...
	// database 表示数据库连接状态，未配置时为 not_configured。
...
const file_system_proto_rawDesc = "" +
	"\n" +
	"\fsystem.proto\x12\x0ftwoto.system.v1\"\x0f\n" +
...
var file_system_proto_goTypes = []any{
	(*HealthRequest)(nil),  // 0: twoto.system.v1.HealthRequest
	(*HealthResponse)(nil), // 1: twoto.system.v1.HealthResponse
	(*PingRequest)(nil),    // 2: twoto.system.v1.PingRequest
	(*PingResponse)(nil),   // 3: twoto.system.v1.PingResponse
	(*SloganRequest)(nil),  // 4: twoto.system.v1.SloganRequest
	(*SloganResponse)(nil), // 5: twoto.system.v1.SloganResponse
}
